...
//extern const int ANALOG_IN;
extern float capacity;
extern float tank1;
//extern const int TANK1_IN;
extern uint16_t tank1adc;
extern float tank1p;
extern float tank2;
//extern const int TANK2_IN;
...
//extern bit_t LMIC_disableChannel (u1_t channel);
//extern void  LMIC_setDrTxpow   (dr_t dr, s1_t txpow);
...
//void WebServerHandler(AsyncWebServer httpServer, configData actconf);
